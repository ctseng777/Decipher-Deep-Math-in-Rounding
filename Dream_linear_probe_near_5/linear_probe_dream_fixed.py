#!/usr/bin/env python3
"""
Linear probe script for Dream-v0-Instruct-7B diffusion language model.
Captures hidden states at every layer during forward pass.
"""
...
print("=" * 60)
print("Linear Probing on Dream-v0-Instruct-7B Diffusion LM")
...
if all_results:
    ...
    # Save JSON
    with open('dream_probe_results.json', 'w') as f:
        json.dump(all_results, f, indent=2)
    print(f"\nResults saved to dream_probe_results.json")
else:
