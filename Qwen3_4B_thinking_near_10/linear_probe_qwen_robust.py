# %% [markdown]
# # StreetMath Linear Probes — Qwen3-4B-Thinking-2507 (Near-10)
# 
# This single Colab cell trains **streaming linear probes** that read "near‑10" (within 1 of a multiple of 10)
# from the **Qwen3-4B-Thinking-2507** model's hidden states, with improvements:
# 
...
# 
# Configured for **Qwen3-4B-Thinking-2507** to analyze the thinking variant's numerical understanding.
# 
# ---
# 
...
MODEL_ID_1 = "Qwen/Qwen3-4B-Thinking-2507"                     # Thinking variant of Qwen3-4B
