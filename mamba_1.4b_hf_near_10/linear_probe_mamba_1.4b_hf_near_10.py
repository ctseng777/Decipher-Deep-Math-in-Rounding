...
def model_layer_meta(model) -> Tuple[int,int]:
    ...
    with torch.no_grad():
        ...
        try:
            ...
            L = 48 + 1  # 48 layers + embedding (typical for 1.4B model)
            D = 1536   # d_model for 1.4B (typical)
...
with open("mamba_1.4b_hf_probe_results_near_10.json", "w") as f:
    json.dump(all_results, f, indent=2)
print(f"\nResults saved to mamba_1.4b_hf_probe_results_near_10.json")
